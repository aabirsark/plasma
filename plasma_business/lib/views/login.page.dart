...
import 'package:plasma_business/views/register.page.dart';
import 'package:plasma_business/views/widgets/auth_button.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  PrimaryButton(
                      ...
                      callback: () async {
                        await _phoneVerification(
                            phoneController, context, isLooading);
                      }),
                  const SizedBox(
                    height: 10,
                  ),
